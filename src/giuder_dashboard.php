...
<body class="bg-page font-display text-textMain min-h-screen">
  ...
  <main class="container mx-auto px-4 lg:px-10 xl:px-32 py-10">
    ...
    <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10">
      <div>
        <h1 class="text-3xl md:text-4xl font-extrabold">Create / Edit Tour</h1>
    ...
    <section class="bg-card border border-border rounded-xl p-6 shadow-sm mb-10">
      ...
      <div class="space-y-3">
        <div class="flex items-center justify-between p-4 rounded-lg bg-input border border-border">
          <div>
            <h3 class="font-bold">Atlas Lion Feeding Session</h3>
            <p class="text-sm text-textBody">Oct 12 · English · 20 pax · $15</p>
          </div>
          <div class="flex gap-2">
            <button class="px-3 py-1 text-sm rounded-lg bg-primary text-white">Edit</button>
            <button class="px-3 py-1 text-sm rounded-lg bg-red-600 text-white">Delete</button>
          </div>
        </div>

        <div class="flex items-center justify-between p-4 rounded-lg bg-input border border-border">
          <div>
            <h3 class="font-bold">Savannah Sunset Tour</h3>
            <p class="text-sm text-textBody">Oct 15 · French · 15 pax · $12</p>
          </div>
          <div class="flex gap-2">
            <button class="px-3 py-1 text-sm rounded-lg bg-primary text-white">Edit</button>
            <button class="px-3 py-1 text-sm rounded-lg bg-red-600 text-white">Delete</button>
    ...
    <section class="bg-card border border-border rounded-xl p-6 shadow-sm">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div class="md:col-span-2">
          ...
          <input type="text" placeholder="Atlas Lion Feeding Session"
        ...
        <div>
          ...
          <select class="w-full bg-input border border-border rounded-lg px-4 py-3">
      ...
      <div class="mt-10 flex justify-end gap-4">
        <button type="button"
          class="px-6 py-3 rounded-lg bg-input text-sm font-bold hover:bg-border">
          Preview
        </button>
        <button type="submit"
          class="px-6 py-3 rounded-lg bg-primary text-white text-sm font-bold hover:opacity-90">
          Save Tour
        </button>
      </div>
      ...
      step.innerHTML = `
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div class="md:col-span-2">
            ...
            <input type="text" placeholder="Welcome & introduction"
